export default function App() {
  ...
  return (
    <div className="text-center aaa p-2.5 text-blue">
      ...
      <div className="text-4xl ma text-green p-2"/>
      {/* variant values */}
      <div className="bg-pink dark:bg-yellow hover:bg-green">
        dark
      </div>
      ...
      <div className="p-1 flex flex-col flex-gap-1 items-center text-#fff" />
      {/* un- prefix variant + important modifier */}
      <div className="b b-green text-right h-10 !text-pink">
        123456789
      </div>
      {/* spread attribute — must be skipped entirely */}
      <div {...({} as any)} className="text-red"/>
      ...
      <div className="x text-red" {...{ a: flex, b: block }} />
      ...
      <div className="i-carbon-logo-twitter mt-2"/>
      {/* nesting + appending to existing className */}
      <div className="[&>div]:w-10 text-red">
        <div className="text-left">
          1
        </div>
        <div className="color-[#233] text-center">
          2
        </div>
      ...
      <div onClick={handler} className="m-2"/>
